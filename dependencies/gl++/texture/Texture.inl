...
void Texture::init(const GLenum internalFormat,
                   const GLsizei width)
{
#pragma deprecated(Texture::init)
...
void Texture::texImage2D(const GLenum internalFormat,
                         const GLsizei width,
                         const GLsizei height,
                         const GLint border,
                         const GLenum externalFormat,
                         const GLenum externalType,
                         const void *pixels)
{
  // bind the Texture first
  bind();
...
template<>
inline Texture::ExternalFormat<GLfloat>::operator GLenum (void) const
{
  return GL_FLOAT;
} // end Texture::ExternalFormat::operator GLenum ()

template<>
inline Texture::ExternalFormat<GLhalf>::operator GLenum (void) const
{
  return GL_HALF_FLOAT_ARB;
} // end Texture::ExternalFormat::operator GLenum ()

template<>
inline Texture::ExternalFormat<GLbyte>::operator GLenum (void) const
{
  return GL_BYTE;
} // end ExternalFormat::operator GLenum ()

template<>
inline Texture::ExternalFormat<GLubyte>::operator GLenum (void) const
{
  return GL_UNSIGNED_BYTE;
} // end Texture::ExternalFormat::operator GLenum ()

template<>
inline Texture::ExternalFormat<GLuint>::operator GLenum (void) const
{
